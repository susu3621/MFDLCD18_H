...
这是适用于 **BBC micro:bit V2** 的 1.8 英寸彩色 LCD MakeCode 图形化扩展。硬件分辨率为 160×128，LCD 驱动芯片为 GC9106。
...
4. 程序开头先使用“初始化 1.8in LCD”和“清空绘图区域”积木。
5. 绘图操作会直接显示；原有“在 LCD 显示绘图缓存”积木为兼容旧项目而保留。
